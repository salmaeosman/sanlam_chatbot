                    ...
                    "parts": [
                        ...
                        },
                        {
                            "text": (
                                ...
                                "vehicule implique, pas la victime. Extrais aussi l assure ou le "
                                "souscripteur mentionne dans le PV. Renseigne le champ assure "
                                "avec type=personne_physique et les champs nom et prenom si c est "
                                "une personne, ou type=personne_morale et nom_societe si c est "
                                "une societe. N utilise jamais compagnie_assurance pour decrire "
                                "l assure. S il y a plusieurs vehicules "
                ...
                "parts": [
                    {
                        "text": (
                            ...
                            "victime. Extrais aussi l assure ou le souscripteur quand il est "
                            "mentionne. Le champ assure designe la personne ou la societe "
                            "assuree, jamais la compagnie d assurance. Utilise type="
                            "personne_physique avec nom et prenom pour une personne, et "
                            "type=personne_morale avec nom_societe pour une societe. Si l assureur est "
